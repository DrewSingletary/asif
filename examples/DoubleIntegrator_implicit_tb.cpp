...
const double P[nx*nx] = {1.0,0.0,0.0,1.0};
const double mPpPt[nx*nx] = {-2.0,0.0,0.0,-2.0};
const double Pv = 0.01;
...
int main()
{
	...
	double xNow[2] = {0.1,0.1};
	double uDesNow[1] = {0.9};
