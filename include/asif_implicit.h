#ifndef _ASIF_IMPLICIT_H_
#define _ASIF_IMPLICIT_H_
...
namespace ASIF
{
	...
	public:
		ASIFimplicit(const uint32_t nx,
		             const uint32_t nu,
		             const uint32_t npSS,
		             const uint32_t npBS,
		...
		vector<double> Lfh_out_;
		vector<vector<double>> Lgh_out_;
		vector<vector<double>> Dh_out_;
		LearningData learning_data_;
	protected:
		ASIFimplicit(const bool dynamicsHasGradient,
		             const uint32_t nx,
		             const uint32_t nu,
		             const uint32_t npSS,
		             const uint32_t npBS,
